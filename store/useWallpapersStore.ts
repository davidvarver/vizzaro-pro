...
const enrichWallpaperData = (data: any[]): Wallpaper[] => {
    ...
    const COLORS = [
        ...
        'TEAL', 'TURQUESA',
        'DARK BROWN', 'LIGHT BROWN', 'BROWN', 'CAFE', 'MARRON', 'MOCHA', 'MOCA', 'WHEAT', 'TRIGO',
        'AQUA',
        'NAVY', 'AZUL MARINO', 'SKY BLUE', 'POWDERED BLUE', 'LIGHT BLUE', 'BLUE', 'AZUL', 'COBALT', 'COBALTO', 'INDIGO', 'INDIGO', 'MOODY', 'DUSTY',
        ...
        'GREEN', 'VERDE', 'EMERALD', 'ESMERALDA', 'SAGE', 'OLIVE', 'OLIVA', 'MINT', 'MENTA', 'MOSS', 'MUSGO', 'CHARTREUSE', 'FOREST', 'PISTACHIO', 'PISTACHE',
        'BEIGE', 'CREAM', 'CREMA', 'TAN', 'TOSTADO', 'TAUPE', 'OATMEAL', 'AVENA', 'NEUTRAL', 'NEUTRO', 'NATURAL',
        'YELLOW', 'AMARILLO', 'MUSTARD', 'MOSTAZA', 'PALE', 'PALIDO',
        'RED', 'ROJO', 'RUST', 'OXIDO', 'BURGUNDY', 'VIOLET', 'VIOLETA', 'VINO',
        'ORANGE', 'NARANJA', 'PEACH', 'DURAZNO', 'CORAL', 'TERRACOTTA', 'TERRACOTA', 'APRICOT', 'ALBARICOQUE',
        'PURPLE', 'MORADO', 'LILAC', 'LILA', 'MAUVE', 'LAVENDER', 'LAVANDA', 'PLUM', 'CIRUELA',
