...
export default function AdminCatalogScreen() {
  ...
  const { wallpapers: catalogItems, updateWallpaper, deleteWallpaper, isLoading, error: contextError, loadWallpapers, resetCatalog } = useWallpaperStore();
  const refetchWallpapers = () => loadWallpapers(true);
